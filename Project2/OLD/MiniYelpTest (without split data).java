...
public class MiniYelpTest extends TestCase {
  ...
  public void testReadFile() {
    ...
    try {
      ...
      instance.buildSearchDatabase("San Francisco","Turkish","$$$","Monday","08:00");
      
      // check size of databases
      assertTrue(instance.getDatabase().size() == 2);
      assertTrue(String.valueOf(instance.getCityDatabase().size()),instance.getCityDatabase().size() == instance.getSortedDatabase().size());
