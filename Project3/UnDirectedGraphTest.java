...
public class UnDirectedGraphTest extends TestCase {
  ...
  public void testIterator(){
    ...
    // get iterator
    Iterator<UnDirectedGraph<Integer,Integer>.UnDirectedGraphNode<Integer,Integer>> it = graph.iterator();
      
    // account for all nodes
    assertTrue(it.next().getKey()+it.next().getKey()+it.next().getKey() == 5+7+8);
  }
